...
public class Dijkstra4Otn extends AlgorithmProcessor {

	 private static Logger log = Logger.getLogger(Dijkstra4Otn.class);
		...
		protected List<CaculatorResultWay> doCaculate(CaculatorParam param ) {
	    	...
	    	return dijkstra(aendid, zendid, param.getRouteCount());
		...
		private List<CaculatorResultWay> dijkstra(String aendid, String zendid, Integer routeCount) {
