...
public class Map 
{
  ...
  public void floydWarshall()
  {
     ...
     int[][] p = new int[A.length][A.length];
       ...
       for (int k2 = 0; k2 < A.length; k2++) {
    	   path.put(k2,  findPathFloyd(0, k2, p));
       }
  ...
  private LinkedHashSet<Integer> findPathFloyd( int startindex , int endindex , int[][] p ){
      
	  LinkedHashSet<Integer> rtnlist = new LinkedHashSet<Integer>();
		rtnlist.add(startindex);
